...
export default function StaffSection({ id = "staff", compact = false, bg = "#fcf6ed" }) {
  return (
    <Section id={id} bg={bg} maxWidth={1080}>
      ...
      <div className="grid grid-cols-1 min-[640px]:grid-cols-3 gap-5">
        {staff.map((m) => (
          <figure
            key={m.name + m.role}
            className="m-0 bg-[#ffffff] border border-[#e8dec9] rounded-[20px] overflow-hidden shadow-[0_8px_22px_rgba(20,130,150,0.07)]"
          >
